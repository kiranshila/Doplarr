...
| `SONARR__ROOT_FOLDER`          | `:sonarr/rootfolder`           | String  | N/A           | The root folder to use by default for Sonarr                                                                                                |
| `RADARR__ROOT_FOLDER`          | `:radarr/rootfolder`           | String  | N/A           | The root folder to use by default for Radarr                                                                                                |
